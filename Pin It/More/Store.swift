...
extension UserDefaults {
    enum Store: String {
        case LifetimeMembership = "com.zizicici.pin.Store.LifetimeMembership"
    }
}

extension Notification.Name {
    static let LifetimeMembership = Notification.Name(rawValue: "com.zizicici.pin.store.purchase.lifetime")
    static let StoreInfoLoaded = Notification.Name(rawValue: "com.zizicici.pin.store.info.loaded")
}
