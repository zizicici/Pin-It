...
extension UIConfigurationStateCustomKey {
    static let colorPickerItem = UIConfigurationStateCustomKey("com.zizicici.pin.cell.colorPicker.item")
}
...
class ColorPickerCell: ColorPickerBaseCell {
    ...
    override func updateConfiguration(using state: UICellConfigurationState) {
        ...
        if let colorPickerItem = state.colorPickerItem {
            ...
            content.textProperties.color = AppColor.text.withAlphaComponent(0.9)
